...
async function createMinimalEarningsTest() {
  try {
    console.log('🧪 CREATING MINIMAL EARNINGS TEST DATA');
    console.log('====================================\n');
    ...
    // Step 2: Create minimal earnings records with only required fields
    console.log('\n2. 💵 Creating minimal earnings records...');
    
    const minimalEarnings = [
      {
        seller_id: sellerId,
        sub_order_id: uuidv4(),
    ...
    for (const earning of minimalEarnings) {
      ...
      if (earningsError) {
        ...
        const ultraMinimal = {
          seller_id: sellerId,
          sub_order_id: earning.sub_order_id,
          parent_order_id: earning.parent_order_id,
        ...
        if (minimalError) {
          console.log(`   ❌ Ultra minimal error:`, minimalError.message);
          continue;
        } else {
          console.log(`   ✅ Created minimal record:`, minimalRecord.id);
    ...
    console.log('\n🎉 MINIMAL EARNINGS TEST COMPLETED!');
    console.log('==================================');
    console.log('');
    console.log('📊 SUMMARY:');
    ...
    console.log('');
    console.log('🚀 PHASE 2 PAYMENT SYSTEM: READY FOR TESTING!');
    console.log('');
    console.log('💡 NEXT STEPS:');
    console.log('   1. Test payout request with available balance');
    console.log('   2. Test admin payout approval workflow');
    ...
    console.error('💥 MINIMAL EARNINGS TEST FAILED:', error.message);
    console.error('Stack:', error.stack);
  }
}

// Run the script
createMinimalEarningsTest();