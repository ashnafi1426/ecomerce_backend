-- =====================================================
-- STEP 2: COMPLETE APPROVAL WORKFLOW SETUP
-- Run this AFTER 01-add-approval-columns-only.sql succeeds
-- =====================================================
...
-- =====================================================
-- AUTO-CREATE STORES FOR EXISTING SELLERS
-- =====================================================
...
-- =====================================================
-- POPULATE store_id FOR EXISTING PRODUCTS
-- =====================================================
UPDATE products p
SET store_id = s.id
FROM stores s
