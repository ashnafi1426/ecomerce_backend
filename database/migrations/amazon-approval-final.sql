-- =====================================================
-- AMAZON-STYLE APPROVAL WORKFLOW - FINAL VERSION
-- This migration ensures proper execution order
-- =====================================================
...
-- =====================================================
-- STEP 3: ADD COLUMNS TO PRODUCTS TABLE (NO CONSTRAINTS YET)
-- =====================================================
...
-- =====================================================
-- STEP 7: UPDATE STORE PRODUCT COUNTS (AFTER COLUMN EXISTS)
-- =====================================================
UPDATE stores s
SET total_products = (
  SELECT COUNT(*)
...
-- =====================================================
-- STEP 8: CREATE STORE_MANAGERS TABLE
-- =====================================================
...
-- =====================================================
-- STEP 9: CREATE PRODUCT_APPROVALS TABLE
-- =====================================================
...
-- =====================================================
-- STEP 10: CREATE APPROVAL_NOTIFICATIONS TABLE
-- =====================================================
