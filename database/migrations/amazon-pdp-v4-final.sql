...
-- Complete Database Migration - V4 FINAL
-- This version removes the problematic is_active index
-- ============================================
...
-- STEP 3: Create indexes (excluding problematic is_active index)
-- ============================================
...
-- Products table indexes (basic ones only)
...
-- Migration complete!
SELECT 'Amazon PDP Migration V4 completed successfully!' as status;
